...
class AuthException extends AppException {
  ...
  AuthException([String? message]) : super(message ?? "", TranslationsKeys.tkAuthError);
}

/// Exception for API-related issues.
class APIException extends AppException {
  /// Constructs an [APIException] with an optional [message].
  APIException([String? message]) : super(message ?? "", TranslationsKeys.tkApiError);
}

/// Exception for network-related issues.
class NetworkException extends AppException {
  /// Constructs a [NetworkException] with an optional [message].
  NetworkException([String? message]) : super(message ?? "", TranslationsKeys.tkNetworkError);
}
...
class FetchingException extends AppException {
  ...
  FetchingException([String? message]) : super(message ?? "", TranslationsKeys.tkFetchingError);
}
