...
// 🏦 Bank Services Module - Transfer Services
  ...
  TranslationsKeys.tkEditBeneficiarySuccessMsg: 'Beneficiary updated successfully',
  ...
  TranslationsKeys.tkReceiptNumberNotValidMsg: 'Receipt number should be between 14 and 24',
  TranslationsKeys.tkMeterNumberRequiredMsg: 'Meter number required',
  TranslationsKeys.tkMeterNumberNotValidMsg: 'Meter number should be between 11 or 13',
  TranslationsKeys.tkAmountRequiredMsg: 'Amount required',
  TranslationsKeys.tkAmountNotValidMsg: 'Amount min is 10',
  TranslationsKeys.tkCustomsBankCodeRequiredMsg: 'Bank code required',
  TranslationsKeys.tkCustomsBankCodeNotValidMsg: 'Bank code should be between 8 and 16',
  TranslationsKeys.tkDeclarationCodeRequiredMsg: 'Authorized Person Code required',
  TranslationsKeys.tkDeclarationCodeNotValidMsg: 'Authorized Person Code should be between 8 and 16',
  TranslationsKeys.tkChequeNumberRequiredMsg: 'Cheque number is required',
  ...
  TranslationsKeys.tkE15ReceiptNumberLabel: 'Receipt Number',
  TranslationsKeys.tkDeclarantCodeLabel: 'Authorized Person Code',
  ...
  TranslationsKeys.tkChequeTypeLabel: 'Cheque Book Category',
  ...
  TranslationsKeys.tkAccountInfoConfirmationMsg: 'Please check account information before proceed',
