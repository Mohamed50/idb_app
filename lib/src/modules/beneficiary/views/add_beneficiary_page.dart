...
class AddBeneficiaryPage extends GetView<AddBeneficiaryViewModel> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              GetBuilder<AddBeneficiaryViewModel>(
  ...
  Future<void> _confirm(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      await BeneficiaryActions.instance.addBeneficiaryFromPage(context);
    }
  }
